...
Source0  : https://mirrors.kernel.org/pub/software/utils/pciutils/pciutils-3.12.0.tar.gz
...
%prep
%setup -q -n pciutils-3.12.0
cd %{_builddir}/pciutils-3.12.0
%patch -P 1 -p1
pushd ..
cp -a pciutils-3.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712880640
