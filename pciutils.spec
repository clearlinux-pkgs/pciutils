...
Version  : 3.9.0
Release  : 40
URL      : https://mirrors.kernel.org/pub/software/utils/pciutils/pciutils-3.9.0.tar.xz
Source0  : https://mirrors.kernel.org/pub/software/utils/pciutils/pciutils-3.9.0.tar.xz
...
%prep
%setup -q -n pciutils-3.9.0
cd %{_builddir}/pciutils-3.9.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671485008
