...
Source0  : https://www.kernel.org/pub/software/utils/pciutils/pciutils-3.6.4.tar.xz
...
%prep
%setup -q -n pciutils-3.6.4
cd %{_builddir}/pciutils-3.6.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586920059
...
cp %{_builddir}/pciutils-3.6.4/COPYING %{buildroot}/usr/share/package-licenses/pciutils/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
%make_install
